...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-7YYZS6E2K0"></script>
        <script>
            ...
            gtag('config', 'G-7YYZS6E2K0');
            // gtag('config', 'G-7YYZS6E2K0', {
            //     'debug_mode': {{ app()->environment('local') ? 'true' : 'false' }}
            // });
        </script>

        <meta name="google-site-verification" content="Vz-00hihw08wzLvV8jnHr6nGyTXwvX-UZlZs806dySY" />
