<div>
    {{-- HERO SECTION --}}
    <livewire:hero hero_quote="Kami Siap Membantu Anda!" hero_title="Kontak"
        hero_subTitle="Hubungi kami untuk konsultasi proyek konstruksi, renovasi, atau perbaikan bangunan. Tim ahli kami siap memberikan solusi terbaik sesuai kebutuhan Anda." />
    <div class="mx-auto max-w-7xl px-6 pt-8">
        ...
        <div class="grid items-start gap-10 lg:grid-cols-2">
            ...
            {{-- LEFT --}}
            <div>
                <h2 class="mb-3 text-3xl font-bold">Mari Terhubung!</h2>
                <p class="mb-6 text-gray-600">
                    Punya pertanyaan atau ingin mendiskusikan rencana pembangunan Anda? Kami di sini untuk mendengarkan
                ...
                <div class="rounded-md bg-white p-6 shadow">
                    <h3 class="mb-2 text-lg font-semibold">Retion Jaya Office</h3>
                    ...
                    <ul class="space-y-2 text-sm text-gray-700">
                        <li>
                            <a href="tel:08787356015" class="hover:text-brand hover:underline">
                                <i class="fa-solid fa-phone"></i> 0878-7356-5015
                            </a>
                        </li>
                        <li>
                            <a href="https://wa.me/6287887355015" class="hover:text-brand hover:underline">
                                <i class="fa-brands fa-whatsapp"></i> 0878-7356-5015
                            </a>
                        </li>
                        <li>
                            <a href="mailto:retdionjaya@gmail.com" class="hover:text-brand hover:underline">
                                <i class="fa-solid fa-envelope"></i> retdionjaya@gmail.com
                            </a>
                        </li>
                        <li>
                ...
                <form wire:submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-900">
                            Nama <span class="text-xs text-red-500">*</span>
                        </label>
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-900">
                            Telepon <span class="text-xs text-red-500">*</span>
                        </label>
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-900">
                            Alamat <span class="text-xs text-red-500">*</span>
                        </label>
                        <textarea rows="4" wire:model.defer="address" placeholder="Tulis alamat Anda"
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-900">
                            Pesan <span class="text-xs text-red-500">*</span>
                        </label>
                        <textarea rows="4" wire:model.defer="message" placeholder="Pesan atau pertanyaan Anda"
                            class="block w-full rounded-md border border-gray-300 bg-gray-50 p-2.5 text-sm"></textarea>
                        @error('message')
                            <span class="text-xs text-red-500">{{ $message }}</span>
                        @enderror
