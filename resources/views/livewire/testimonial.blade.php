<div>
    {{-- HERO SECTION --}}
    <livewire:hero hero_quote="Apa Kata Klien Kami" hero_title="Testimoni"
        hero_subTitle="Kepercayaan klien adalah prioritas kami. Simak pengalaman mereka bekerja sama dengan tim ahli kami dalam mewujudkan bangunan impian." />
                ...
                <div class="rounded-base shadow-xs flex">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            @php
                                // Mapping label bahasa Inggris ke Indonesia diletakkan di luar loop agar lebih efisien
                                $labels = [
                                    'Latest' => 'Terbaru',
                                    'Oldest' => 'Terlama',
                                    'Highest' => 'Rating Tertinggi',
                                ...
                                @foreach (['Latest', 'Oldest', 'Highest', 'Lowest'] as $item)
                                    <li>
                                        ...
                                        <button wire:click="setSort('{{ $item }}'); open = false"
                                            class="hover:bg-neutral-tertiary-medium hover:text-heading {{ $sort === $item ? 'bg-gray-100 font-bold text-blue-600' : '' }} block w-full rounded-md p-2 text-left transition-colors">
                                            {{ $labels[$item] ?? $item }}
                                        </button>
                                    </li>
                                @endforeach
                ...
                @if (count($testimonials) == 0)
                    <div class="flex flex-col items-center justify-center py-10">
                        ...
                        <p class="mt-2 max-w-sm text-center text-sm text-gray-500">
                            Kami belum menambahkan cerita pengalaman klien saat ini. Silakan kembali lagi nanti atau
                            jadilah
