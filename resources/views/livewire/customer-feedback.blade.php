<div class="bg-white">
    {{-- HERO SECTION --}}
    <livewire:hero hero_quote="Suara Anda, Kebanggaan Kami" hero_title="Umpan Balik Pelanggan"
        hero_subTitle="Bagikan pengalaman Anda menggunakan jasa kami. Kritik dan saran Anda sangat berharga bagi kami untuk terus meningkatkan kualitas konstruksi dan layanan di masa mendatang." />
    <div class="mx-auto max-w-7xl px-6 pt-8">
        ...
        <form class="space-y-4 rounded-md bg-white p-6 shadow">
            ...
            <div>
                <label class="mb-1 block text-sm font-medium text-gray-900">
                    Kategori <span class="text-xs text-red-500">*</span>
                </label>
            ...
            <div>
                ...
                <textarea wire:model.defer="message" rows="5" placeholder="Tulis pesan Anda di sini..."
            ...
            <button type="button" onclick="submitFeedback()" wire:loading.attr="disabled" wire:target="submit"
                ...
                <span wire:loading.remove wire:target="submit">Kirim Umpan Balik</span>
