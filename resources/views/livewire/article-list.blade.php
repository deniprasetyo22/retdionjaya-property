<div>
    {{-- HERO SECTION --}}
    <livewire:hero hero_quote="Wawasan & Edukasi" hero_title="Artikel Konstruksi"
        hero_subTitle="Temukan tips pembangunan, tren arsitektur terbaru, dan panduan teknis untuk mewujudkan bangunan yang aman, efisien, dan berkualitas." />
                ...
                @if (count($articles) == 0)
                    <div class="flex flex-col items-center justify-center py-16 text-center">
                        ...
                        <p class="mt-2 max-w-sm text-center text-sm text-gray-500">
                            Kami belum menerbitkan artikel atau berita saat ini. Silakan kembali lagi nanti untuk
                            informasi
