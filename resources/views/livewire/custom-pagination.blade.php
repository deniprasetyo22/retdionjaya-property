        ...
        <nav aria-label="Page navigation example" class="flex flex-wrap items-center justify-center gap-4">
            ...
            <div class="w-28">
                <select wire:model.live="perPage"
                    class="bg-neutral-secondary-medium border-default-medium text-heading rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body block w-full border px-2 py-2 text-xs leading-4">
                    <option value="9">9 per halaman</option>
                    <option value="18">18 per halaman</option>
                    <option value="27">27 per halaman</option>
