<div x-data="{ showFilter: false }">
    {{-- HERO SECTION --}}
    <livewire:hero hero_quote="Daftar Proyek Unggulan" hero_title="Portofolio Konstruksi"
        hero_subTitle="Bukti nyata komitmen kami dalam membangun struktur kokoh dengan ketelitian di setiap detailnya." />

    <section class="py-12 md:py-16">
        <div class="mx-auto max-w-7xl px-6">

            <div class="mb-6 flex flex-col gap-4">
                <h2 class="text-xl font-semibold text-gray-800">Daftar Proyek</h2>
                ...
                <div class="rounded-base shadow-xs flex">
                    ...
                    <div class="relative">
                        <button id="dropdown-sort-button" data-dropdown-toggle="sort" type="button"
                            ...
                            <span class="truncate">
                                <i class="fa-solid fa-filter mr-1 sm:mr-2"></i>
                                {{ $sort === 'Latest' ? 'Terbaru' : ($sort === 'Oldest' ? 'Terlama' : $sort) }}
                            </span>
                ...
                @if (count($projects) == 0)
                    <div class="flex flex-col items-center justify-center py-10">
                        ...
                        <p class="mt-2 max-w-sm text-center text-sm text-gray-500">
                            Saat ini kami sedang mempersiapkan proyek renovasi dan konstruksi terbaru. Nantikan
                            pembaruan hasil
