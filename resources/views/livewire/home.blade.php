<div x-data="{
    ...
    <div x-show="loading" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100"
        ...
        <img src="{{ asset('images/Logo.png') }}" alt="Loading..."
            class="h-18 w-auto animate-pulse object-contain md:h-28">
    ...
    <section class="relative">
        ...
        {{-- HERO WRAPPER --}}
        <div class="relative h-[600px] bg-cover bg-center md:h-screen"
            ...
            <div class="relative z-20 flex h-full items-center">
                <div class="mx-auto max-w-4xl px-6 text-center text-white">
                    <h1 class="mb-4 text-4xl font-bold md:text-5xl">
                        Membangun Fondasi, Mewujudkan Inovasi
                    </h1>

                    <p class="mx-auto mb-8 max-w-4xl text-center text-sm font-light text-gray-200 md:text-lg">
                        Menghadirkan solusi konstruksi berkualitas tinggi dengan standar profesional untuk setiap proyek
                        hunian maupun komersial Anda.
                    </p>
                    ...
                    <div class="flex justify-center gap-4">
                        ...
                        <button wire:click="toggleModalVideo"
                            class="rounded-full border border-white bg-white/20 px-4 py-3 text-sm hover:bg-white/30">
                            ▶ Profil Perusahaan
                        </button>
                    </div>
                </div>
    ...
    <section class="scroll-animate mx-auto mt-14 max-w-7xl px-6 text-center md:mt-16">
        <h2 class="mb-2 text-2xl font-bold">
            Jelajahi
            <span class="font-secondary italic text-blue-600">Proyek Kami</span>
        </h2>
        ...
        @if (count($projects) == 0)
            <div class="flex flex-col items-center justify-center py-10">
                ...
                <p class="mt-2 max-w-sm text-center text-sm text-gray-500">
                    Saat ini kami sedang mempersiapkan proyek renovasi dan konstruksi terbaru. Nantikan pembaruan hasil
                    ...
                    <div class="overflow-hidden rounded-xl shadow">
                        <div class="relative overflow-hidden">
                            ...
                            @elseif ($project->status === 'In Progress')
                                <span
                                    class="absolute left-0 top-0 z-10 rounded-lg bg-blue-500 px-4 py-1 text-sm text-white">
                                    Dalam Proses
                                </span>
                            @endif
        ...
        <div class="mt-8">
            <a href="{{ route('project-list') }}"
                class="mt-2 inline-flex items-center gap-2 rounded-full border border-blue-600 px-4 py-1.5 text-sm text-blue-600 transition hover:bg-blue-600 hover:text-white">
    ...
    <section class="scroll-animate mt-12 flex bg-gray-50 py-8 md:py-16">
        <div class="mx-auto grid max-w-7xl gap-10 px-6 md:grid-cols-2">
            <div class="order-2 grid h-[280px] grid-cols-5 grid-rows-2 gap-4 md:order-1 md:h-[360px]">
                ...
                <img src="{{ asset('images/image-4.png') }}"
                    class="col-span-3 row-span-1 h-full w-full rounded-xl object-cover" />
            </div>


            <div class="order-1 flex flex-col justify-center md:order-2">
                <h2 class="mb-4 text-center text-2xl font-bold md:text-left">Mengapa Memilih Kami?</h2>
                <p class="mb-6 text-justify text-gray-600">
                    Kami adalah mitra terpercaya Anda untuk proyek renovasi, perbaikan, dan konstruksi bangunan.
                    Dengan tim tenaga ahli profesional dan pengalaman bertahun-tahun, kami memastikan setiap proyek
                    diselesaikan dengan standar kualitas tinggi, tepat waktu, dan sesuai anggaran. Komitmen kami
                    adalah memberikan hasil bangunan yang kokoh, aman, dan tahan lama untuk properti Anda.
                </p>
    ...
    <section class="scroll-animate mt-12 bg-gray-50 py-10">
        <div class="mx-auto max-w-7xl px-6 text-center">
            <h2 class="mb-4 text-2xl font-bold">
                Artikel
                <span class="font-secondary italic text-blue-600">Terbaru</span>
            </h2>
            ...
            @if (count($articles) == 0)
                <div class="flex flex-col items-center justify-center py-10">
                    ...
                    <p class="mt-2 max-w-sm text-center text-sm text-gray-500">
                        Kami belum menerbitkan artikel atau berita saat ini. Silakan kembali lagi nanti untuk informasi
                        terbaru seputar konstruksi.
                    </p>
                </div>
            @else
                <div class="mt-10 grid gap-6 md:grid-cols-3">
    ...
    <section class="scroll-animate mx-auto mt-12 max-w-7xl px-6 text-center">
        <h2 class="mb-2 text-2xl font-bold">
            Apa Kata <span class="font-secondary italic text-blue-600">Klien Kami</span>
        </h2>
        ...
        @if (count($testimonials) == 0)
            <div class="flex flex-col items-center justify-center py-10">
                ...
                <p class="mt-2 max-w-sm text-center text-sm text-gray-500">
                    Kami belum menambahkan cerita pengalaman klien saat ini. Silakan kembali lagi nanti atau jadilah
                    yang pertama membagikan pengalaman Anda bekerja sama dengan kami!
                </p>
            </div>
        @else
            <div class="mt-10 grid gap-6 md:grid-cols-3">
                @foreach ($testimonials as $testimonial)
                    <div class="rounded-xl bg-white p-8 text-center shadow">
                        ...
                        <p class="mb-4 text-sm text-gray-500">
                            ...
                            {{ Str::title($testimonial->project->location) }}
                        </p>
